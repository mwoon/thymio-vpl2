...
/*!
  HomeScreen sets up the layout for the homescreen. It provides the interface for a user to switch between \l GameInterface, \l VplInterface and \l GameSimulator.
*/
Item {
